!(function (a) {
    ...
    function e(b) {
        ...
        a.each(b, function (a) {
            (c = a.match(/^([^A-Z]+?)([A-Z])/)) &&
                -1 !== "a aa ai ao as b fn i m o s ".indexOf(c[1] + " ") &&
    ...
    function g(a) {
        ...
        !a.sEmptyTable &&
            ...
            Fa(a, a, "sZeroRecords", "sEmptyTable"),
            !a.sLoadingRecords &&
                c &&
                "Loading..." === b.sLoadingRecords &&
                Fa(a, a, "sZeroRecords", "sLoadingRecords"),
    ...
    function h(a) {
        if (
            (jb(a, "ordering", "bSort"),
            jb(a, "orderMulti", "bSortMulti"),
            jb(a, "orderClasses", "bSortClasses"),
            jb(a, "orderCellsTop", "bSortCellsTop"),
            jb(a, "order", "aaSorting"),
            jb(a, "orderFixed", "aaSortingFixed"),
            jb(a, "paging", "bPaginate"),
            jb(a, "pagingType", "sPaginationType"),
            jb(a, "pageLength", "iDisplayLength"),
            jb(a, "searching", "bFilter"),
            ...
            for (var b = 0, c = a.length; b < c; b++)
                a[b] && f(Ua.models.oSearch, a[b]);
    }
    function i(b) {
        jb(b, "orderable", "bSortable"),
            jb(b, "orderData", "aDataSort"),
            jb(b, "orderSequence", "asSorting"),
            jb(b, "orderDataType", "sortDataType");
        var c = b.aDataSort;
    ...
    function j(c) {
        if (!Ua.__browser) {
            ...
            (d.barWidth = f[0].offsetWidth - f[0].clientWidth),
                ...
                (d.bBounding = !!e[0].getBoundingClientRect().width),
                e.remove();
        }
        a.extend(c.oBrowser, Ua.__browser),
            (c.oScroll.iBarWidth = Ua.__browser.barWidth);
    }
    ...
    function l(b, d) {
        ...
        b.aoColumns.push(e),
            (e = b.aoPreSearchCols),
            (e[f] = a.extend({}, Ua.models.oSearch, e[f])),
            m(b, f, a(d).data());
    }
    function m(b, c, e) {
        var c = b.aoColumns[c],
        ...
        e !== d &&
            null !== e &&
            (i(e),
            f(Ua.defaults.column, e),
            e.mDataProp !== d && !e.mData && (e.mData = e.mDataProp),
            e.sType && (c._sManualType = e.sType),
            e.className && !e.sClass && (e.sClass = e.className),
            e.sClass && h.addClass(e.sClass),
            a.extend(c, e),
            Fa(c, e, "sWidth", "sWidthOrig"),
            e.iDataSort !== d && (c.aDataSort = [e.iDataSort]),
            Fa(c, e, "aDataSort"));
        var k = c.mData,
            l = z(k),
        ...
        (c._bAttrSrc =
            a.isPlainObject(k) && (e(k.sort) || e(k.type) || e(k.filter))),
            (c._setter = null),
            ...
            b.oFeatures.bSort ||
                ((c.bSortable = !1), h.addClass(g.sSortableNone)),
            (b = -1 !== a.inArray("asc", c.asSorting)),
            (e = -1 !== a.inArray("desc", c.asSorting)),
            c.bSortable && (b || e)
                ? b && !e
                    ? ((c.sSortingClass = g.sSortableAsc),
                      (c.sSortingClassJUI = g.sSortJUIAscAllowed))
                    : !b && e
                    ? ((c.sSortingClass = g.sSortableDesc),
                      (c.sSortingClassJUI = g.sSortJUIDescAllowed))
                    : ((c.sSortingClass = g.sSortable),
                      (c.sSortingClassJUI = g.sSortJUI))
                : ((c.sSortingClass = g.sSortableNone),
                  (c.sSortingClassJUI = ""));
    }
    function n(a) {
            ...
            if (((i = l[b]), (k = []), !i.sType && i._sManualType))
                ...
                for (e = 0, f = n.length; e < f; e++) {
                    for (
                        g = 0, h = m.length;
                        g < h &&
                        (k[g] === d && (k[g] = w(a, g, b, "type")),
                        (j = n[e](k[g], a)) || e === n.length - 1) &&
                        "html" !== j;
                        g++
                    );
                    if (j) {
            ...
            for (g = c.length - 1; 0 <= g; g--) {
                ...
                for (a.isArray(o) || (o = [o]), h = 0, i = o.length; h < i; h++)
                    if ("number" == typeof o[h] && 0 <= o[h]) {
                        ...
                        f(o[h], m);
                    } else if ("number" == typeof o[h] && 0 > o[h])
                        f(n.length + o[h], m);
                    else if ("string" == typeof o[h])
                        for (j = 0, k = n.length; j < k; j++)
                            ("_all" == o[h] || a(n[j].nTh).hasClass(o[h])) &&
                                f(j, m);
            }
    ...
    function u(b, c, e, f) {
        ...
        for (var i = b.aoColumns, j = 0, k = i.length; j < k; j++)
            i[j].sType = null;
        return (
                    ...
                    if (((h = f[j].match(kb)), (i = f[j].match(lb)), h)) {
                        if (
                            ...
                            for (i = 0, k = e.length; i < k; i++)
                                (g = {}), c(g, e[i], h), b[f[j]].push(g);
                        else b[f[j]] = e;
                        return;
                    }
                    i && ((f[j] = f[j].replace(lb, "")), (b = b[f[j]](e))),
                        (null !== b[f[j]] && b[f[j]] !== d) || (b[f[j]] = {}),
                        (b = b[f[j]]);
                }
                g.match(lb)
                    ? b[g.replace(lb, "")](e)
    ...
    function E(a, b, c, e) {
        ...
        if ("dom" !== c && ((c && "auto" !== c) || "dom" !== g.src)) {
            ...
            if (i)
                if (e !== d) h(i[e], e);
                else for (c = 0, f = i.length; c < f; c++) h(i[c], c);
        ...
        var g,
            ...
            o = function (a, b) {
                if ("string" == typeof a) {
                    var c = a.indexOf("@");
                    -1 !== c &&
                        ((c = a.substring(c + 1)), A(a)(f, b.getAttribute(c)));
                }
            },
            p = function (b) {
                (e !== d && e !== l) ||
        ...
        if (k)
            for (; k; )
                (g = k.nodeName.toUpperCase()),
                    ...
                    (k = k.nextSibling);
        else for (j = c.anCells, k = 0, g = j.length; k < g; k++) p(j[k]);
        return (
            (c = c.firstChild ? c : c.nTr) &&
                (c = c.getAttribute("id")) &&
                A(b.rowId)(f, c),
            { data: f, cells: j }
        );
            ...
            for (
                ...
                (i = b.aoColumns[j]),
                    ...
                    (e && !i.mRender && i.mData === j) ||
                        (a.isPlainObject(i.mData) &&
                            i.mData._ === j + ".display") ||
                        (h.innerHTML = w(b, d, j, "display")),
    ...
    function H(b, c) {
        ...
        if (d) {
            ...
            f && (d.id = f),
                e.DT_RowClass &&
                    ((f = e.DT_RowClass.split(" ")),
                    (c.__rowc = c.__rowc ? ib(c.__rowc.concat(f)) : f),
                    a(d)
    ...
    function I(b) {
        var c,
            ...
            k = b.oClasses,
            l = b.aoColumns;
        for (j && (f = a("<tr/>").appendTo(h)), c = 0, d = l.length; c < d; c++)
            (g = l[c]),
                ...
                b.oFeatures.bSort &&
                    ...
                    !1 !== g.bSortable &&
                        (e
                            .attr("tabindex", b.iTabIndex)
                            .attr("aria-controls", b.sTableId),
                        ya(b, g.nTh, c))),
        ...
        if (
            ...
            for (b = b.aoFooter[0], c = 0, d = b.length; c < d; c++)
                (g = l[c]),
                    (g.nTf = b[c].cell),
    ...
    function J(b, c, e) {
        ...
        if (c) {
            for (e === d && (e = !1), f = 0, g = c.length; f < g; f++) {
                for (
                    j[f] = c[f].slice(), j[f].nTr = c[f].nTr, h = l - 1;
                    0 <= h;
                    h--
                )
                    !b.aoColumns[h].bVisible && !e && j[f].splice(h, 1);
                k.push([]);
            }
            for (f = 0, g = j.length; f < g; f++) {
                ...
                for (h = 0, c = j[f].length; h < c; h++)
                    if (((i = l = 1), k[f][h] === d)) {
                        for (
                            b.appendChild(j[f][h].cell), k[f][h] = 1;
                            j[f + l] !== d && j[f][h].cell == j[f + l][h].cell;
            ...
            if (0 !== k.length)
                for (h = j ? b.aoData.length : l, j = j ? 0 : i; j < h; j++) {
                    ...
                    if ((null === n.nTr && G(b, m), (m = n.nTr), 0 !== g)) {
                        var o = f[e % g];
                        n._sRowStripe != o &&
                            (a(m).removeClass(n._sRowStripe).addClass(o),
                            (n._sRowStripe = o));
                    }
                    Ja(b, "aoRowCallback", null, [m, n._aData, e, j]),
                        c.push(m),
                        e++;
                }
            else
    ...
    function M(b) {
        ...
        for (
            var g, h, i, j, k, l, m = b.sDom.split(""), n = 0;
            n < m.length;
            n++
        ) {
            if (((g = null), "<" == (h = m[n]))) {
                if (((i = a("<div/>")[0]), "'" == (j = m[n + 1]) || '"' == j)) {
                    ...
                    "H" == k
                        ...
                        -1 != k.indexOf(".")
                            ? ((j = k.split(".")),
                              (i.id = j[0].substr(1, j[0].length - 1)),
                              (i.className = j[1]))
                            : "#" == k.charAt(0)
                            ? (i.id = k.substr(1, k.length - 1))
                            : (i.className = k),
                        (n += l);
                }
                f.append(i), (f = a(i));
    ...
    function P(b, c, d) {
        ...
        (k = {
            ...
            error: function (c, d) {
                ...
                -1 === a.inArray(!0, e) &&
                    ("parsererror" == d
                        ? Ea(b, 0, "Invalid JSON response", 1)
                        : 4 === c.readyState && Ea(b, 0, "Ajax error", 7)),
                    la(b, !1);
            },
        }),
            (b.oAjaxData = c),
            Ja(b, null, "preXhr", [b, c]),
            b.fnServerData
                ? b.fnServerData.call(
                      i,
                      b.sAjaxSource,
                ...
                ? (b.jqXHR = a.ajax(a.extend(k, { url: h || b.sAjaxSource })))
                : a.isFunction(h)
                ? (b.jqXHR = h.call(i, c, j, b))
                : ((b.jqXHR = a.ajax(a.extend(k, h))), (h.data = g));
    }
    function Q(a) {
        return (
            !a.bAjaxDataGet ||
    ...
    function R(b) {
        var c,
            ...
            m = ua(b);
        (c = b._iDisplayStart),
            (d = !1 !== i.bPaginate ? b._iDisplayLength : -1);
        var n = function (a, b) {
            l.push({ name: a, value: b });
        };
        n("sEcho", b.iDraw),
            n("iColumns", h),
            n("sColumns", eb(g, "sName").join(",")),
            n("iDisplayStart", c),
            n("iDisplayLength", d);
        var o = {
            draw: b.iDraw,
        ...
        for (c = 0; c < h; c++)
            (e = g[c]),
                ...
                n("mDataProp_" + c, d),
                i.bFilter &&
                    (n("sSearch_" + c, f.sSearch),
                    n("bRegex_" + c, f.bRegex),
                    n("bSearchable_" + c, e.bSearchable)),
                i.bSort && n("bSortable_" + c, e.bSortable);
        return (
            i.bFilter && (n("sSearch", j.sSearch), n("bRegex", j.bRegex)),
            i.bSort &&
                (a.each(m, function (a, b) {
                    o.order.push({ column: b.col, dir: b.dir }),
                        n("iSortCol_" + a, b.col),
                        n("sSortDir_" + a, b.dir);
                }),
                n("iSortingCols", m.length)),
            (g = Ua.ext.legacy.ajax),
            null === g ? (b.sAjaxSource ? l : o) : g ? l : o
        );
    }
    function S(a, b) {
        var c = T(a, b),
        ...
        if ((s(a), "ssp" != Ma(a))) {
            for (
                Y(
                    ...
                    b.sSearch,
                    c,
                    b.bEscapeRegex !== d ? !b.bEscapeRegex : b.bRegex,
                    b.bSmart,
                    b.bCaseInsensitive
                ),
                    g(b),
                ...
                X(
                    ...
                    f[b].sSearch,
                    b,
                    f[b].bEscapeRegex !== d ? !f[b].bEscapeRegex : f[b].bRegex,
                    f[b].bSmart,
                    f[b].bCaseInsensitive
                );
            W(a);
        } else g(b);
    ...
    function W(b) {
        for (
            var c, d, e = Ua.ext.search, f = b.aiDisplay, g = 0, h = e.length;
            g < h;
            g++
        ) {
            for (var i = [], j = 0, k = f.length; j < k; j++)
                (d = f[j]),
                    (c = b.aoData[d]),
    ...
    function X(a, b, c, d, e, f) {
        if ("" !== b) {
            for (
                var g = [], h = a.aiDisplay, d = Z(b, d, e, f), e = 0;
                e < h.length;
                e++
            )
    ...
    function Y(a, b, c, d, e, f) {
        var g,
            ...
            h = a.aiDisplayMaster,
            e = [];
        if ((0 !== Ua.ext.search.length && (c = !0), (g = $(a)), 0 >= b.length))
            a.aiDisplay = h.slice();
        else {
            for (
                (g ||
                ...
                for (g = [], d = 0, f = j.length; d < f; d++)
                    (b = j[d]),
                        ...
                        h.indexOf &&
                            -1 !== h.indexOf("&") &&
                            ((nb.innerHTML = h),
                            (h = ob ? nb.textContent : nb.innerText)),
    ...
    function ba(b) {
        ...
        return (
            d ||
                (b.aoDrawCallback.push({ fn: ca, sName: "information" }),
    ...
    function ea(a) {
        ...
        if (a.bInitialised) {
            for (
                ...
                (d = f[b]), d.sWidth && (d.nTh.style.width = ta(d.sWidth));
            Ja(a, null, "preInit", [a]),
                L(a),
                (f = Ma(a)),
                ("ssp" != f || g) &&
    ...
    function ha(b) {
        for (
            ...
            f[0][h] = new Option(
                "number" == typeof e[h] ? b.fnFormatNumber(e[h]) : e[h],
                g[h]
            );
        ...
        return (
            ...
            j
                .children()
                .append(
                    b.oLanguage.sLengthMenu.replace("_MENU_", f[0].outerHTML)
                ),
            a("select", j)
                    ...
                    fn: function (a) {
                        if (e) {
                            var b,
                                ...
                                i = d(c, h),
                                j = 0;
                            for (b = g.p.length; j < b; j++)
                                La(a, "pageButton")(a, g.p[j], j, i, c, h);
                        } else d.fnUpdate(a, f);
                    },
                    sName: "pagination",
                })),
    ...
    function ma(b) {
        ...
        var e = d.sX,
            ...
            l = c.children("tfoot");
        l.length || (l = null),
            (j = a("<div/>", { class: g.sScrollWrapper })
                .append(
                    a("<div/>", { class: g.sScrollHead })
                        .css({
                            overflow: "hidden",
                            position: "relative",
                            border: 0,
                        ...
                        .append(
                            a("<div/>", { class: g.sScrollHeadInner })
                                .css({
            ...
            l &&
                j.append(
                    a("<div/>", { class: g.sScrollFoot })
                        ...
                        .append(
                            a("<div/>", { class: g.sScrollFootInner }).append(
                                k
                                    .removeAttr("id")
                                    .css("margin-left", 0)
        ...
        return (
            ...
            (b.nScrollBody = g),
            (b.nScrollFoot = n),
            b.aoDrawCallback.push({ fn: na, sName: "scrolling" }),
            j[0]
        );
    }
    function na(b) {
        ...
        (e = q.scrollHeight > q.clientHeight),
            b.scrollBarVis !== e && b.scrollBarVis !== d
                ? ((b.scrollBarVis = e), n(b))
                : ((b.scrollBarVis = e),
                  y.children("thead, tfoot").remove(),
                  B &&
                      ((f = B.clone().prependTo(y)),
                      (c = B.find("tr")),
                      (f = f.find("tr"))),
                  (g = x.clone().prependTo(y)),
                  (x = x.find("tr")),
                  (e = g.find("tr")),
                  g.find("th, td").removeAttr("tabindex"),
                  j || ((u.width = "100%"), (m[0].style.width = "100%")),
                  a.each(O(b, g), function (a, c) {
                  ...
                  "" === j
                      ? ((A.width = "100%"),
                        D &&
                            (y.find("tbody").height() > q.offsetHeight ||
                                "scroll" == t.css("overflow-y")) &&
                            (A.width = ta(y.outerWidth() - i)),
                        (m = y.outerWidth()))
                      : "" !== k && ((A.width = ta(k)), (m = y.outerWidth())),
                  oa(J, e),
                  oa(function (b) {
                  ...
                  y.outerWidth() < m
                      ? ((c =
                        ...
                        D &&
                            ...
                            (A.width = ta(c - i)),
                        ("" === j || "" !== k) &&
                            Ea(b, 1, "Possible column misalignment", 6))
                      : (c = "100%"),
                  (u.width = ta(c)),
                  (p.width = ta(c)),
                  B && (b.nScrollFoot.style.width = ta(c)),
                  !l && D && (u.height = ta(z.offsetHeight + i)),
                  (j = y.outerWidth()),
                  (s[0].style.width = ta(j)),
                  (r.width = ta(j)),
                  (k =
                      y.height() > q.clientHeight ||
                      "scroll" == t.css("overflow-y")),
                  (l = "padding" + (C.bScrollbarLeft ? "Left" : "Right")),
                  (r[l] = k ? i + "px" : "0px"),
                  B &&
                      ((w[0].style.width = ta(j)),
                      (v[0].style.width = ta(j)),
                      (v[0].style[l] = k ? i + "px" : "0px")),
                  y.children("colgroup").insertBefore(y.children("thead")),
                  t.scroll(),
                  (!b.bSorted && !b.bFiltered) ||
                      b._drawHold ||
                      (q.scrollTop = 0));
    }
    function oa(a, b, c) {
    ...
    function pa(c) {
        var d,
            ...
            h = v.bScrollOversize;
        for (
            (d = f.style.width) && -1 !== d.indexOf("%") && (s = d), d = 0;
            d < m.length;
            d++
        )
            (e = g[m[d]]),
                null !== e.sWidth &&
                    ((e.sWidth = qa(e.sWidthOrig, t)), (u = !0));
        if (h || (!u && !j && !i && l == q(c) && l == p.length))
            for (d = 0; d < l; d++)
                null !== (m = o(c, d)) && (g[m].sWidth = ta(p.eq(d).width()));
        else {
            (l = a(f).clone().css("visibility", "hidden").removeAttr("id")),
                l.find("tbody tr").remove();
            var w = a("<tr/>").appendTo(l.find("tbody"));
            for (
                l.find("thead, tfoot").remove(),
                    l.append(a(c.nTHead).clone()).append(a(c.nTFoot).clone()),
                    l.find("tfoot th, tfoot td").css("width", ""),
                    p = O(c, l.find("thead")[0]),
                    d = 0;
                d < m.length;
                d++
            )
            ...
            for (
                ...
                (t = a(p[d])),
                    ...
                    (t = v.bBounding
                        ? Math.ceil(p[d].getBoundingClientRect().width)
                        : t.outerWidth()),
                    (i += t),
                    (g[m[d]].sWidth = ta(t - k));
            (f.style.width = ta(i)), e.remove();
        }
        s && (f.style.width = ta(s)),
            (!s && !j) ||
                c._reszEvt ||
                ((f = function () {
                    a(b).on(
    ...
    function ua(b) {
        ...
        for (
            ...
            for (
                i = l[b][0], f = k[i].aDataSort, c = 0, e = f.length;
                c < e;
                c++
            )
                (g = f[c]),
                    (h = k[g].sType || "string"),
                    l[b]._idx === d &&
                        (l[b]._idx = a.inArray(l[b][1], k[g].asSorting)),
                    j.push({
                        src: i,
                        col: g,
                        dir: l[b][1],
    ...
    function va(a) {
        var b,
            ...
            i = 0,
            j = a.aiDisplayMaster;
        for (s(a), e = ua(a), b = 0, c = e.length; b < c; b++)
            (d = e[b]), d.formatter && i++, Aa(a, d.col);
        ...
        var g = b.aaSorting,
            ...
            i = function (b, c) {
                ...
                return (
                    ...
                    e + 1 < h.length ? e + 1 : c ? null : 0
                );
            };
        "number" == typeof g[0] && (g = b.aaSorting = [g]),
            e && b.oFeatures.bSortMulti
                ? ((e = a.inArray(c, eb(g, "0"))),
                  -1 !== e
                      ? ((c = i(g[e], !0)),
                        null === c && 1 === g.length && (c = 0),
                        null === c
                            ? g.splice(e, 1)
                            : ((g[e][1] = h[c]), (g[e]._idx = c)))
                      : (g.push([c, h[0], 0]), (g[g.length - 1]._idx = 0)))
                : g.length && g[0][0] == c
                ? ((c = i(g[0])),
                  (g.length = 1),
                  (g[0][1] = h[c]),
                  (g[0]._idx = c))
                : ((g.length = 0), g.push([c, h[0]]), (g[0]._idx = 0)),
            L(b),
    ...
    function za(b) {
        ...
        if (h.bSort && h.bSortClasses) {
            for (h = 0, c = e.length; h < c; h++)
                (d = e[h].src),
                    a(eb(b.aoData, "anCells", d)).removeClass(
                        f + (2 > h ? h + 1 : 3)
                    );
            for (h = 0, c = g.length; h < c; h++)
                (d = g[h].src),
                    a(eb(b.aoData, "anCells", d)).addClass(
                        f + (2 > h ? h + 1 : 3)
                    );
        }
        b.aLastSort = g;
    ...
    function Aa(a, b) {
        ...
        for (
            var f,
                g = Ua.ext.type.order[d.sType + "-pre"],
                h = 0,
                i = a.aoData.length;
            h < i;
            h++
            ...
            (d = a.aoData[h]),
                d._aSortData || (d._aSortData = []),
                (!d._aSortData[b] || e) &&
                    ((f = e ? c[h] : w(a, h, b, "sort")),
    ...
    function Ba(b) {
        if (b.oFeatures.bStateSave && !b.bDestroying) {
            ...
            Ja(b, "aoStateSaveParams", "stateSaveParams", [b, c]),
                (b.oSavedState = c),
    ...
    function Ca(b, c, e) {
        var f,
            ...
            c = function (c) {
                if (c && c.time) {
                    var i = Ja(b, "aoStateLoadParams", "stateLoadParams", [
                        b,
                        c,
                    ]);
                    if (
                        -1 === a.inArray(!1, i) &&
                        !(
                            (0 < (i = b.iStateDuration) &&
                                c.time < +new Date() - 1e3 * i) ||
                            (c.columns && h.length !== c.columns.length)
                        )
                    ) {
                        if (
                            ((b.oLoadedState = a.extend(!0, {}, c)),
                            c.start !== d &&
                                ((b._iDisplayStart = c.start),
                            ...
                            c.order !== d &&
                                ...
                                a.each(c.order, function (a, c) {
                                    b.aaSorting.push(
                                        c[0] >= h.length ? [0, c[1]] : c
                                    );
                                })),
                            c.search !== d &&
                                a.extend(b.oPreviousSearch, aa(c.search)),
                            c.columns)
                        )
                            for (f = 0, g = c.columns.length; f < g; f++)
                                (i = c.columns[f]),
                                    i.visible !== d &&
                                        (h[f].bVisible = i.visible),
                                    i.search !== d &&
                                        a.extend(
                                            b.aoPreSearchCols[f],
                                            aa(i.search)
    ...
    function Ea(a, c, d, e) {
        if (
            ...
            ((c = Ua.ext),
            (c = c.sErrMode || c.errMode),
            a && Ja(a, null, "error", [a, e, d]),
            "alert" == c)
        )
            alert(d);
        else {
    ...
    function Ja(b, c, d, e) {
        ...
        return (
            c &&
                (f = a.map(b[c].slice().reverse(), function (a) {
                    return a.fn.apply(b.oInstance, e);
                })),
            null !== d &&
                ((c = a.Event(d + ".dt")),
                a(b.nTable).trigger(c, e),
                f.push(c.result)),
            f
        );
    }
    ...
    function Na(a, b) {
        ...
        return (
            b <= c
                ? (c = gb(0, b))
                : a <= d
                ? ((c = gb(0, c - 2)), c.push("ellipsis"), c.push(b - 1))
                : (a >= b - 1 - d
                      ? (c = gb(b - (c - 2), b))
                      : ((c = gb(a - d + 2, a + d - 1)),
                        c.push("ellipsis"),
    ...
    function Oa(b) {
        a.each(
            ...
            function (a, c) {
                (Qa.type.order[a + b + "-pre"] = c),
                    a.match(/^html\-/) &&
                        (Qa.type.search[a + b] = Qa.type.search.html);
            }
        );
    }
    function Pa(a) {
        return function () {
            var b = [Da(this[Ua.ext.iApiIndex])].concat(
    ...
    var Qa,
            ...
            (this.$ = function (a, b) {
                ...
                (this.fnAddData = function (b, c) {
                    var e = this.api(!0),
                        f =
                            a.isArray(b) &&
                            (a.isArray(b[0]) || a.isPlainObject(b[0]))
                                ? e.rows.add(b)
                                : e.row.add(b);
                ...
                this.each(function () {
                    ...
                    if ("table" != this.nodeName.toLowerCase())
                        ...
                        for (n = x.length; q < n; q++) {
                            ...
                            if (
                                y.nTable == this ||
                                y.nTHead.parentNode == this ||
                                (y.nTFoot && y.nTFoot.parentNode == this)
                            ) {
                                var A =
                                    p.bRetrieve !== d
                                        ? p.bRetrieve
                                ...
                                if (
                                    p.bDestroy !== d ? p.bDestroy : s.bDestroy
                                ) {
                        ...
                        (null !== o && "" !== o) ||
                            (this.id = o =
                                "DataTables_Table_" + Ua.ext._unique++);
                        ...
                        (B.nTable = this),
                            ...
                            Fa(B.oLanguage, p, "fnInfoCallback"),
                            Ia(B, "aoDrawCallback", p.fnDrawCallback, "user"),
                            Ia(B, "aoServerParams", p.fnServerParams, "user"),
                            Ia(
                                B,
                                "aoStateSaveParams",
                                p.fnStateSaveParams,
                            ...
                            Ia(B, "aoStateLoaded", p.fnStateLoaded, "user"),
                            Ia(B, "aoRowCallback", p.fnRowCallback, "user"),
                            Ia(
                                B,
                            ...
                            Ia(B, "aoInitComplete", p.fnInitComplete, "user"),
                            Ia(
                                B,
                                "aoPreDrawCallback",
                                p.fnPreDrawCallback,
                            ...
                            j(B);
                        var C = B.oClasses;
                        a.extend(C, Ua.ext.classes, p.oClasses),
                            w.addClass(C.sTable),
                            B.iInitDisplayStart === d &&
                                ((B.iInitDisplayStart = p.iDisplayStart),
                                (B._iDisplayStart = p.iDisplayStart)),
                            null !== p.iDeferLoading &&
                                ((B.bDeferLoading = !0),
                                (o = a.isArray(p.iDeferLoading)),
                                (B._iRecordsDisplay = o
                                    ? p.iDeferLoading[0]
                                    : p.iDeferLoading),
                                (B._iRecordsTotal = o
                                    ? p.iDeferLoading[1]
                        ...
                        if (
                            (-1 !==
                                ...
                                (a("tbody tr", this).removeClass(o.join(" ")),
                                (B.asDestroyStripes = o.slice())),
                            (o = []),
                            (x = this.getElementsByTagName("thead")),
                            0 !== x.length && (N(B.aoHeader, x[0]), (o = O(B))),
                            null === p.aoColumns)
                        )
                            for (x = [], q = 0, n = o.length; q < n; q++)
                                x.push(null);
                        else x = p.aoColumns;
                        for (q = 0, n = x.length; q < n; q++)
                            l(B, o ? o[q] : null);
                        if (
                            (t(B, p.aoColumnDefs, x, function (a, b) {
                                m(B, a, b);
                            }),
                            E.length)
                        ) {
                        ...
                        var G = B.oFeatures,
                            o = function () {
                                if (p.aaSorting === d) {
                                    var b = B.aaSorting;
                                    for (q = 0, n = b.length; q < n; q++)
                                        b[q][1] = B.aoColumns[q].asSorting[0];
                                }
                                za(B),
                                    G.bSort &&
                                ...
                                var b = w.children("caption").each(function () {
                                        this._captionSide =
                                            a(this).css("caption-side");
                                    }),
                                    c = w.children("thead");
                                if (
                                    (0 === c.length &&
                                        (c = a("<thead/>").appendTo(w)),
                                    (B.nTHead = c[0]),
                                    (c = w.children("tbody")),
                                    0 === c.length &&
                                        (c = a("<tbody/>").appendTo(w)),
                                    (B.nTBody = c[0]),
                                    (c = w.children("tfoot")),
                                    0 === c.length &&
                                        b.length > 0 &&
                                        ("" !== B.oScroll.sX ||
                                            "" !== B.oScroll.sY) &&
                                        (c = a("<tfoot/>").appendTo(w)),
                                    0 === c.length || 0 === c.children().length
                                        ? w.addClass(C.sNoFooter)
                                        : c.length > 0 &&
                                          ((B.nTFoot = c[0]),
                                    ...
                                    (B.bDeferLoading || "dom" == Ma(B)) &&
                                        v(B, a(B.nTBody).children("tr"));
                        ...
                        p.bStateSave
                            ? ((G.bStateSave = !0),
                              Ia(B, "aoDrawCallback", Ba, "state_save"),
                              Ca(B, p, o))
                            : o();
                    }
                }),
        ...
        bb = function (a, b) {
            return (
                Va[b] || (Va[b] = RegExp(mb(b), "g")),
                "string" == typeof a && "." !== b
                    ? a.replace(/\./g, "").replace(Va[b], ".")
                    : a
            );
        },
        cb = function (a, b, c) {
        ...
        db = function (a, b, c) {
            return (
                !!_a(a) ||
                (_a(a) || "string" == typeof a
                    ? !!cb(a.replace(Xa, ""), b, c) || null
                    : null)
            );
        },
        eb = function (a, b, c) {
        ...
        fb = function (a, b, c, e) {
            var f = [],
                g = 0,
                h = b.length;
            if (e !== d) for (; g < h; g++) a[b[g]][c] && f.push(a[b[g]][c][e]);
            else for (; g < h; g++) f.push(a[b[g]][c]);
            return f;
        },
        gb = function (a, b) {
            var c,
    ...
    (Ra = function (b, c) {
        ...
        if (a.isArray(b)) for (var f = 0, g = b.length; f < g; f++) e(b[f]);
        else e(b);
        (this.context = ib(d)),
            c && a.merge(this, c),
        ...
        a.extend(Ra.prototype, {
            ...
            iterator: function (a, b, c, e) {
                ...
                for (
                    ...
                    var p = new Ra(n[g]);
                    if ("table" === b)
                        (f = c.call(p, n[g], g)) !== d && m.push(f);
                    else if ("columns" === b || "rows" === b)
                        (f = c.call(p, n[g], this[g], g)) !== d && m.push(f);
                    else if (
                        "column" === b ||
                        "column-rows" === b ||
                        "row" === b ||
                        ...
                        for (
                            ...
                            (f = l[i]),
                                (f =
                                    "cell" === b
                                        ? c.call(p, n[g], f.row, f.column, g, i)
                                        : c.call(p, n[g], f, g, i, k)) !== d &&
                                    m.push(f);
                }
                return m.length || e
                    ? ((a = new Ra(n, a ? m.concat.apply([], m) : m)),
                      (b = a.selector),
                      (b.rows = o.rows),
                      (b.cols = o.cols),
                      (b.opts = o.opts),
            ...
            if (d.length && c && (c instanceof Ra || c.__dt_wrapper)) {
                ...
                for (e = 0, f = d.length; e < f; e++)
                    (g = d[e]),
                        ...
                        Ra.extend(b, c[g.name], g.propExt);
            }
        }),
        (Ra.register = Sa =
            function (b, c) {
                if (a.isArray(b))
                    ...
                    for (
                        var f, g, h = b.split("."), i = rb, d = 0, e = h.length;
                        d < e;
                        d++
                    ) {
                        f = (g = -1 !== h[d].indexOf("()"))
                        ...
                        j ||
                            ...
                            d === e - 1
                                ? (j.val = c)
                                : (i = g ? j.methodExt : j.propExt);
                    }
            }),
        (Ra.registerPlural = Ta =
            function (b, c, e) {
                Ra.register(b, e),
                    Ra.register(c, function () {
    ...
    var ub = function (a, b, c) {
        ...
        if ("ssp" == Ma(a)) L(a, b);
            ...
            e && 4 !== e.readyState && e.abort(),
                P(a, [], function (c) {
                    C(a);
                    for (var c = T(a, c), d = 0, e = c.length; d < e; d++)
                        u(a, c[d]);
                    L(a, b), la(a, !1);
                });
        }
    ...
    var vb = function (b, c, e, f, g) {
        ...
        yb = function (b, c) {
            ...
            d = b.aiDisplayMaster;
            var i = c.search;
            if (((e = c.order), (f = c.page), "ssp" == Ma(b)))
                return "removed" === i ? [] : gb(0, d.length);
            if ("current" == f)
                for (d = b._iDisplayStart, e = b.fnDisplayEnd(); d < e; d++)
                    g.push(h[d]);
                ...
                for (d = 0, e = b.aoData.length; d < e; d++)
                    "none" == i
                        ? g.push(d)
                        : ((-1 === (f = a.inArray(d, h)) && "removed" == i) ||
                              (0 <= f && "applied" == i)) &&
                          g.push(d);
            return g;
        };
                ...
                function (e) {
                    ...
                    return vb(
                        ...
                        function (b) {
                            ...
                            if (((c = hb(fb(e.aoData, f, "nTr"))), b.nodeName))
                                return b._DT_RowIndex !== d
                                    ? [b._DT_RowIndex]
                                    : b._DT_CellIndex
                                    ? [b._DT_CellIndex.row]
                                    : ((c = a(b).closest("*[data-dt-row]")),
                                      c.length ? [c.data("dt-row")] : []);
                ...
                this.iterator("row", function (b, c, e) {
                    ...
                    for (k.splice(c, 1), f = 0, g = k.length; f < g; f++)
                        if (
                            ((h = k[f]),
                            (j = h.anCells),
                            null !== h.nTr && (h.nTr._DT_RowIndex = f),
                            null !== j)
                        )
                            for (h = 0, i = j.length; h < i; h++)
                                j[h]._DT_CellIndex.row = f;
                    D(b.aiDisplayMaster, c),
                        D(b.aiDisplay, c),
                        D(a[e], c, !1),
                        0 < b._iRecordsDisplay && b._iRecordsDisplay--,
                        Ka(b),
                        (c = b.rowIdFn(l._aData)) !== d && delete b.aIds[c];
                }),
    ...
    var zb = function (a, b) {
            var c = a.context;
            c.length &&
                (c = c[0].aoData[b !== d ? b : a[0]]) &&
                c._details &&
                (c._details.remove(), (c._detailsShow = d), (c._details = d));
        },
        Ab = function (a, b) {
            var c = a.context;
    ...
    Sa("row().child()", function (b, c) {
        var e = this.context;
        if (b === d)
            return e.length && this.length ? e[0].aoData[this[0]]._details : d;
                ...
                h = function (b, c) {
                    if (a.isArray(b) || b instanceof a)
                        ...
                        b.nodeName && "tr" === b.nodeName.toLowerCase()
                            ? g.push(b)
                            : ((d = a("<tr><td/></tr>").addClass(c)),
                              (a("td", d).addClass(c).html(b)[0].colSpan =
                                  q(f)),
                              g.push(d[0]));
                };
            h(b, c),
    ...
    Sa("columns()", function (b, c) {
                ...
                function (d) {
                    ...
                    return vb(
                        ...
                        function (b) {
                            ...
                            return b.nodeName && b._DT_CellIndex
                                ? [b._DT_CellIndex.column]
                                : ((c = a(i)
                                      .filter(b)
                                      .map(function () {
                                  ...
                                  c.length || !b.nodeName
                                      ? c
                                      : ((c =
                                            a(b).closest("*[data-dt-column]")),
                                        c.length ? [c.data("dt-column")] : []));
                        },
                        d,
                        f
                    );
        ...
        Ta("columns().visible()", "column().visible()", function (b, c) {
            ...
            return (
                b !== d &&
                    (this.iterator("column", function (a, d) {
        ...
        (Ua.versionCheck = Ua.fnVersionCheck =
            function (a) {
                for (
                    var b,
                        c,
        ...
        (Ua.isDataTable = Ua.fnIsDataTable =
            function (b) {
                ...
                return (
                    b instanceof Ua.Api ||
                    (a.each(Ua.settings, function (b, e) {
                        var f = e.nScrollHead
                                ? a("table", e.nScrollHead)[0]
                                : null,
                            g = e.nScrollFoot
                                ? a("table", e.nScrollFoot)[0]
                                : null;
        ...
        Sa("destroy()", function (c) {
            return (
                ...
                this.iterator("table", function (d) {
                    ...
                    (d.bDestroying = !0),
                        Ja(d, "aoDestroyCallback", "destroy", [d]),
                        c || new Ra(d).columns().visible(!0),
                        m.off(".DT").find(":not(tbody *)").off(".DT"),
                        a(b).off(".DT-" + d.sInstance),
                        h != j.parentNode &&
                            (l.children("thead").detach(), l.append(j)),
                        k &&
                            h != k.parentNode &&
                        ...
                        !c &&
                            ...
                            l
                                .css("width", d.sDestroyWidth)
                                .removeClass(g.sTable),
                            (e = d.asDestroyStripes.length) &&
                                i.children().each(function (b) {
                                    a(this).addClass(d.asDestroyStripes[b % e]);
                                })),
                        -1 !== (f = a.inArray(d, Ua.settings)) &&
                            Ua.settings.splice(f, 1);
                })
            );
        }),
    ...
    a.extend(Db, {
        ...
        a.extend(Ua.ext.type.detect, [
            ...
            function (a) {
                return _a(a) || ("string" == typeof a && -1 !== a.indexOf("<"))
                    ? "html"
                    : null;
            },
        ]),
            ...
            header: {
                ...
                jqueryui: function (b, c, d, e) {
                    a("<div/>")
                        ...
                        .append(
                            a("<span/>").addClass(
                                e.sSortIcon + " " + d.sSortingClassJUI
                            )
                        )
                        .appendTo(c),
                        a(b.nTable).on("order.dt.DT", function (a, f, g, h) {
                            ...
                            t = function (b) {
                                b.preventDefault(),
                                    !a(b.currentTarget).hasClass("disabled") &&
                                        n.page() != b.data.action &&
                                        n.page(b.data.action).draw("page");
                            };
                        for (e = 0, f = d.length; e < f; e++)
                            if (((m = d[e]), a.isArray(m))) s(c, m);
                                ...
                                k &&
                                    ((h = a("<li>", {
                                        ...
                                        .appendTo(c)),
                                    b.oApi._fnBindAction(h, { action: m }, t),
                                    r++);
                            }
                    };
                try {
