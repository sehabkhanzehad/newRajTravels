...
@section('pageTitle', 'Dashboard | M/S Raj Travels')
@section('content')
    <section class="content home">
        <div class="container-fluid">

            @include('dashboard.components.common.breadcrumb', ['title' => 'Dashboard'])
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info">
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar1.jpg"
                                                            alt="Avatar"></li>
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar2.jpg"
                                                            alt="Avatar"></li>
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar3.jpg"
                                                            alt="Avatar"></li>
                                                </ul>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info">
                                                    ...
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar3.jpg"
                                                            alt="Avatar"></li>
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar4.jpg"
                                                            alt="Avatar"></li>
                                                </ul>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info">
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar4.jpg"
                                                            alt="Avatar"></li>
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar6.jpg"
                                                            alt="Avatar"></li>
                                                </ul>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info">
                                                    ...
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar2.jpg"
                                                            alt="Avatar"></li>
                                                    <li><img src="{{ asset('adminDashboard') }}/images/xs/avatar9.jpg"
                                                            alt="Avatar"></li>
                                                </ul>
                                            </td>
                                            <td>
                            ...
                            <ul class="follow_us list-unstyled">
                                    ...
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object "
                                                src="{{ asset('adminDashboard') }}/images/xs/avatar4.jpg" alt="">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object "
                                                src="{{ asset('adminDashboard') }}/images/xs/avatar5.jpg" alt="">
                                            <div class="media-body">
                        ...
                        <div class="body m-b-10">
                            <div class="row">
                                <div class="col-5 col-md-5 text-center">
                                    <input type="text" class="knob" value="86" data-width="50"
                                        data-height="50" data-thickness="0.2" data-fgColor="#e5678f">
                                </div>
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-warning btn-icon btn-icon-mini btn-round"><i
