                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card">
                        <div class="body m-b-10">
                            <button type="button" class="btn btn-round btn-info waves-effect" data-toggle="modal"
                                data-target="#addevent">Add Events</button>
                        </div>
                    ...
                    <div class="card">
                            ...
                            <ul class="header-dropdown">
                                <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle"
                                    ...
                                    <ul class="dropdown-menu slideUp">
                                        <li><a href="{{ route('dashboard.website.packages.create') }}">Add Package</a></li>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table id="tableData" class="table table-bordered table-striped table-hover dataTable">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Package Name</th>
...
@section('scripts')
    <script>
        ...
        async function getData() {
            showLoader();
            const respons = await axios.get("{{ route('dashboard.website.packages.list') }}");
            hideLoader();
