...
<!-- Mirrored from www.wrraptheme.com/templates/alpino/main/file-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 16:35:20 GMT -->
<head>
<meta charset="utf-8">
...
<title>:: Alpino :: file-dashboard</title>
    ...
    <div id="leftsidebar" class="sidebar">
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" ><i class="zmdi zmdi-folder-star"></i><span>My Collection</span></a></li>
                ...
                <li><a href="javascript:void(0);" ><i class="zmdi zmdi-circle-o col-blue"></i><span>Family</span></a></li>
                <li><a href="javascript:void(0);" ><i class="zmdi zmdi-circle-o col-green"></i><span>Work</span></a></li>
                <li><a href="javascript:void(0);" ><i class="zmdi zmdi-circle-o col-amber"></i><span>Holidays</span></a></li>
                <li><a href="javascript:void(0);" ><i class="zmdi zmdi-circle-o col-blush"></i><span>Music</span></a></li>
                <li><a href="javascript:void(0);" ><i class="zmdi zmdi-circle-o col-red"></i><span>Photography</span></a></li>
            </ul>
        </div>
    </div>
</aside>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="body l-green">
                        <h4 class="m-t-0">32GB <i class="zmdi zmdi-storage"></i></h4>
                        <div class="progress m-t-10">
                            <div class="progress-bar l-dark" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;"></div>
                        </div>
                        <small class="info text-muted">Storage of 1Tb</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="body">
                        <h4 class="m-t-0">2GB <i class="zmdi zmdi-file-text"></i></h4>
                        <div class="progress m-t-10">
                            <div class="progress-bar l-dark" role="progressbar" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100" style="width: 12%;"></div>
                        </div>
                        <small class="info text-muted">Documents of 1Tb</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
